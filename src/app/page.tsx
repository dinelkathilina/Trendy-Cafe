...
import { ArrowRight, Coffee, MapPin, Clock, Instagram, Facebook, Twitter, Plus, ShoppingCart, Menu, X } from 'lucide-react';
...
const ConcentricCircles = ({ className }: { className?: string }) => (
  <svg className={className} width="100" height="100" viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
    <circle cx="50" cy="50" r="48" stroke="currentColor" strokeWidth="2" strokeDasharray="4 4" opacity="0.2"/>
    <circle cx="50" cy="50" r="38" stroke="currentColor" strokeWidth="2" opacity="0.3"/>
    <circle cx="50" cy="50" r="28" stroke="currentColor" strokeWidth="2" strokeDasharray="4 4" opacity="0.4"/>
    <circle cx="50" cy="50" r="18" stroke="currentColor" strokeWidth="2" opacity="0.5"/>
  </svg>
);
    ...
    <div className="font-sans bg-slate-50 min-h-screen overflow-x-hidden text-slate-800">
      ...
      <nav className="fixed top-4 md:top-6 left-1/2 -translate-x-1/2 w-[95%] max-w-7xl bg-white/95 backdrop-blur-md rounded-full px-4 md:px-6 py-3 md:py-4 flex justify-between items-center z-50 shadow-sm border border-slate-100">
        ...
        <div className="hidden lg:flex items-center justify-center gap-6 xl:gap-8 font-medium text-slate-600">
          ...
          <a href="#" className="hover:text-purple-600 transition-colors whitespace-nowrap">Menu</a>
          <a href="#" className="hover:text-purple-600 transition-colors whitespace-nowrap">Our Story</a>
          <a href="#" className="hover:text-purple-600 transition-colors whitespace-nowrap">Contact</a>
        </div>
        <div className="flex items-center justify-end gap-2 md:gap-4 shrink-0 flex-1">
          ...
          >
            <div className="w-6 h-6 flex flex-col justify-center items-center relative">
              <motion.span
                animate={isMobileMenuOpen ? { y: 0, rotate: 45 } : { y: -8, rotate: 0 }}
      ...
      <AnimatePresence>
        ...
        {isMobileMenuOpen && (
          ...
          >
            <a href="#" className="font-semibold text-slate-700 hover:text-purple-600 hover:bg-purple-50 p-3 rounded-xl transition-all text-lg">Home</a>
            <a href="#" className="font-semibold text-slate-700 hover:text-purple-600 hover:bg-purple-50 p-3 rounded-xl transition-all text-lg">Menu</a>
            <a href="#" className="font-semibold text-slate-700 hover:text-purple-600 hover:bg-purple-50 p-3 rounded-xl transition-all text-lg">Our Story</a>
            <a href="#" className="font-semibold text-slate-700 hover:text-purple-600 hover:bg-purple-50 p-3 rounded-xl transition-all text-lg">Contact</a>
      ...
      {/* Hero Section */}
      <section className="relative w-full h-[90vh] min-h-[600px] flex items-center justify-center overflow-hidden m-4 rounded-[3rem] w-[calc(100%-2rem)] mx-auto">
        <div className="absolute inset-0 z-0">
          <img src="https://images.unsplash.com/photo-1497935586351-b67a49e012bf?q=80&w=2071&auto=format&fit=crop" alt="Coffee and pastry" className="w-full h-full object-cover" referrerPolicy="no-referrer" />
        ...
        >
          <h1 className="text-5xl md:text-7xl lg:text-8xl font-extrabold text-white leading-tight">
            Artisan Coffee & <br/>
            <span className="font-caveat text-amber-400 text-6xl md:text-8xl lg:text-9xl font-normal tracking-wide inline-block transform -rotate-2 my-2">Fresh Pastries</span><br/>
            Baked Daily.
          </h1>
      ...
      <section className="py-24 px-6 max-w-7xl mx-auto relative">
        ...
        <div className="text-center mb-16 relative">
          <h2 className="text-4xl md:text-5xl font-extrabold text-slate-900">
            Our <span className="font-caveat text-purple-600 text-5xl md:text-6xl font-normal">best-selling</span> items
          </h2>
          <p className="text-slate-500 mt-4 max-w-2xl mx-auto text-lg">
            Discover our most loved pastries and signature coffee drinks, crafted with care and the finest ingredients.
          </p>
        </div>
      ...
      <section className="py-24 px-6 max-w-7xl mx-auto flex flex-col md:flex-row items-center gap-16 relative">
        <div className="flex-1 relative z-10">
          <h2 className="text-4xl md:text-5xl font-extrabold text-slate-900 leading-tight mb-6">
            ...
            <span className="font-caveat text-purple-600 text-5xl md:text-6xl font-normal relative inline-block">
              local beans
              <svg className="absolute w-full h-4 -bottom-1 left-0 text-amber-400" viewBox="0 0 100 20" preserveAspectRatio="none">
                <path d="M0 10 Q 50 20 100 10" stroke="currentColor" strokeWidth="4" fill="none" strokeLinecap="round" />
              </svg>
            </span>
          </h2>
          <p className="text-slate-600 text-lg mb-8 leading-relaxed">
            We believe that great coffee starts with great beans. That's why we source our beans directly from local farmers who share our passion for quality and sustainability. Every cup you drink supports our community and brings you the freshest taste possible. Come enjoy our cozy interior and let the aroma of freshly baked pastries make your day.
          </p>
        ...
        <div className="flex-1 relative w-full">
          ...
          <img src="https://images.unsplash.com/photo-1554118811-1e0d58224f24?q=80&w=2047&auto=format&fit=crop" alt="Cozy interior" className="relative z-10 rounded-[2rem] shadow-2xl object-cover aspect-[4/3] w-full border-8 border-white" referrerPolicy="no-referrer" />
          ...
          <div className="absolute -top-6 -right-6 z-20 bg-white rounded-full p-4 shadow-xl border border-slate-100 flex items-center justify-center w-28 h-28 transform rotate-12">
            <div className="text-center">
              <span className="block font-caveat text-purple-600 text-2xl leading-none">100%</span>
              <span className="block text-xs font-bold text-slate-800 uppercase tracking-wider mt-1">Local</span>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 px-6 max-w-7xl mx-auto">
        <div className="text-center mb-16 relative">
          ...
          <h2 className="text-4xl md:text-5xl font-extrabold text-slate-900">
            Follow our <span className="font-caveat text-purple-600 text-5xl md:text-6xl font-normal">Instagram</span>
          </h2>
          <p className="text-slate-500 mt-4 max-w-2xl mx-auto text-lg">
            @trendycafe_local
          </p>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          {Array.from({length: 16}).map((_, i) => (
            <div key={i} className="aspect-square rounded-2xl overflow-hidden group relative bg-slate-200">
              <img src={`https://picsum.photos/seed/cafe${i + 10}/400/400`} alt="Instagram post" className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110" referrerPolicy="no-referrer" />
      ...
      <footer className="bg-purple-700 text-white py-20 px-6 rounded-t-[3rem] mt-12 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-12 text-center md:text-left relative z-10">
          <div>
            ...
            <p className="text-purple-200 mb-8 text-lg max-w-sm mx-auto md:mx-0">
              Your favorite local spot for artisan coffee and fresh, daily-baked pastries.
            </p>
            <div className="flex items-center justify-center md:justify-start gap-4">
              <a href="#" className="bg-purple-600 p-3 rounded-full hover:bg-amber-400 hover:text-purple-900 transition-colors"><Instagram size={20} /></a>
              <a href="#" className="bg-purple-600 p-3 rounded-full hover:bg-amber-400 hover:text-purple-900 transition-colors"><Facebook size={20} /></a>
              <a href="#" className="bg-purple-600 p-3 rounded-full hover:bg-amber-400 hover:text-purple-900 transition-colors"><Twitter size={20} /></a>
            </div>
          </div>
          
          <div>
            <h3 className="text-xl font-bold mb-6 text-amber-400 font-outfit">Business Hours</h3>
            <ul className="space-y-4 text-purple-100">
              <li className="flex justify-between max-w-xs mx-auto md:mx-0 border-b border-purple-600/50 pb-2">
                <span>Monday - Friday</span> <span className="font-semibold text-white">7:00 AM - 6:00 PM</span>
              </li>
              <li className="flex justify-between max-w-xs mx-auto md:mx-0 border-b border-purple-600/50 pb-2">
                <span>Saturday</span> <span className="font-semibold text-white">8:00 AM - 5:00 PM</span>
              </li>
              <li className="flex justify-between max-w-xs mx-auto md:mx-0 border-b border-purple-600/50 pb-2">
                <span>Sunday</span> <span className="font-semibold text-white">8:00 AM - 3:00 PM</span>
              </li>
            </ul>
          </div>
          
          <div>
            <h3 className="text-xl font-bold mb-6 text-amber-400 font-outfit">Location & Contact</h3>
            <ul className="space-y-6 text-purple-100">
              <li className="flex items-start justify-center md:justify-start gap-4">
                ...
                <span className="pt-1">123 Artisan Way<br/>Coffee District<br/>Cityville, ST 12345</span>
              </li>
              <li className="flex items-center justify-center md:justify-start gap-4">
                <div className="bg-purple-600 p-2 rounded-lg shrink-0">
                  <Clock size={24} className="text-amber-400" />
                </div>
                <span className="text-lg">Call us: <span className="font-semibold text-white">(555) 123-4567</span></span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto mt-16 pt-8 border-t border-purple-600 text-center text-purple-300 text-sm relative z-10">
          <p>&copy; {new Date().getFullYear()} TrendyCafe. All rights reserved.</p>
        </div>
      </footer>
